...
$ajax = file_get_contents($root . '/application/admin/controller/Ajax.php');
$sql = file_get_contents($root . '/release/sql/2026091712_source_sync_v3.sql');

p181Assert($route !== false && $legacyApp !== false && $v3 !== false && $sync !== false && $changes !== false && $model !== false && $admin !== false && $ajax !== false && $sql !== false, 'required source files missing');
...
echo "OK phase18_1_source_v3_contract_test legacy=preserved routes=passed revision=passed pagination=passed delta=passed sort=passed\n";
