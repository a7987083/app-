...
foreach(['ipa-ignore-table','ipa_lifecycle/ignored_list','ipa_lifecycle/ignore_batch','ipa_lifecycle/unignore_batch','ipa_lifecycle/sweep_expired','can-retry'] as $needle)phase207lcAssert(strpos($js,$needle)!==false,'lifecycle FastAdmin JS '.$needle);
