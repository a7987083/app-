                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input name="agent_id" type="text" class="form-control" placeholder="代理 ID" value="{{ $arr->agent_id }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="type" class="form-control select2" required disabled>
                                        <option value="default" {{ ($arr->type === 'default') ? 'selected' : '' }}>默认模式</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="transition_type" class="form-control select2" required disabled>
                                        <option value="default" {{ ($arr->transition_type === 'default') ? 'selected' : '' }}>根据签名系统的选择资源池</option>
                                        <option value="good" {{ ($arr->transition_type === 'good') ? 'selected' : '' }}>使用过滤接口的秒出资源池</option>
                                        <option value="processing" {{ ($arr->transition_type === 'processing') ? 'selected' : '' }}>使用过滤接口的预约资源池</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="transition_create" type="text" class="form-control" placeholder="" value="{{ $arr->transition_create }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
