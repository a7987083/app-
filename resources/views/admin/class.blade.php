...
@section('title'){{ __('分类列表') }}@endsection
@section('link')
...
@section('script')
    <script>
        ...
        DataTable.on('click', '.edit-btn', function() {
            ...
            RedirectTo(systemPath+'/class/edit/'+data['id']);
        });
        DataTable.on('click', '.delete-btn', function() {
            ...
            layer.confirm('您确定要删除软件分类 “'+data['name']+'” 吗？', {
                btn: ['确定', '取消']
            }, function() {
                layer.load(2);
                SendAjax({
